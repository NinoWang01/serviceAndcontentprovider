...
public class MyIntentService extends IntentService {
    ...
    private void handleActionFoo(String param1, String param2) {
        new Thread(){
            ...
            public void run() {
                super.run();
                try {
                    Log.d("------------handleActionFoo1","00000");

                    sleep(50000);
                    Log.d("------------handleActionFoo1","1111111");
        ...
        Log.d("------------handleActionFoo","param1:"+param1+",param2:"+param2);
    }
    ...
    private void handleActionBaz(String param1, String param2) {
        Log.d("------------handleActionBaz","param1:"+param1+",param2:"+param2);
